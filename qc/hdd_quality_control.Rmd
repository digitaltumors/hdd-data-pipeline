...
- **LINCS** We accessed the compound info from the 2020 release of the LINCS perturbation experiments. These experiments were also conducted by the Broad Institute.
- **OASIS** We accessed a published HDD membership artifact from the CPG0037 OASIS embedding pipeline.
- **GEOM** We accessed a published HDD membership artifact from the GEOM descriptor pipeline.
