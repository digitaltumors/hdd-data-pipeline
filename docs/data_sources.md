# Data Sources (HDD_v2.1)

This document lists the external inputs and generated datasets used to build the Harmonized Drug Dataset Version 2.1 (HDD_v2.1). Versions and URLs are defined in `config/pipeline.yaml`.
...
| HDD_v2.1 MAE | `data/results/HDD_v2.1.RDS` | `workflow/scripts/construct_MAE.R` | colData + experiment matrices |
| HDD_v2.1 CSV exports | `data/results/HDD_v2.1_csv/` | `workflow/scripts/export_mae_csvs.R` | HDD_v2.1 MAE, including Morgan fingerprint assays |
